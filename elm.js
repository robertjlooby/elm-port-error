...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var currentTime = $Time.every($Time.second);
   var main = A2($Signal.map,$Graphics$Element.show,currentTime);
   var outgoing = Elm.Native.Port.make(_elm).outboundSignal("outgoing",
   function (v) {
      return v;
   },
   currentTime);

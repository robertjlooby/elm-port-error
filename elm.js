...
var _robertjlooby$elm_port_error$Main$outgoing = _elm_lang$core$Native_Platform.outgoingPort(
	'outgoing',
	function (v) {
		return v;
	});
var _robertjlooby$elm_port_error$Main$update = F2(
	function (_p0, model) {
		var _p1 = _p0;
		var _p2 = _p1._0;
		return {
			ctor: '_Tuple2',
			_0: _p2,
			_1: _robertjlooby$elm_port_error$Main$outgoing(_p2)
		};
	});
var _robertjlooby$elm_port_error$Main$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _robertjlooby$elm_port_error$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			...
			update: _robertjlooby$elm_port_error$Main$update,
			subscriptions: function (_p3) {
				return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _robertjlooby$elm_port_error$Main$Tick);
			}
		})
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _robertjlooby$elm_port_error$Main$main === 'undefined' ? null : _robertjlooby$elm_port_error$Main$main);
